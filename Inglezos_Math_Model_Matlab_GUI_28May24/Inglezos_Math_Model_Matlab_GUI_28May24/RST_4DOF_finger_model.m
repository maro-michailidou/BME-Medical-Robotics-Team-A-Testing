classdef RST_4DOF_finger_model < handle
    ...
    methods
        ...
        function createFingerModel(obj)
            ...
            jnt1.PositionLimits = [deg2rad(-20), deg2rad(20)]; % Limit MCP abduction/adduction
            setFixedTransform(jnt1, dhparams(1, :), 'dh');
            body1.Joint = jnt1;
            
            body2 = rigidBody('body2');
            jnt2 = rigidBodyJoint('MCP_fe', 'revolute');
            jnt2.PositionLimits = [deg2rad(-10), deg2rad(80)]; % Limit MCP flexion/extension
            ...
            obj.ee_pos = [obj.P_ph + obj.M_ph + obj.D_ph 0 0];
        ...
        function showModel(obj)
            ...
            show(obj.fingerRobotModel, obj.q, "Frames", "on");
        end
